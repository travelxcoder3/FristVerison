            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-emerald-600">{{ Auth::user()->agency->name ?? 'إدارة الوكالة' }}</h1>
                ...
                <div class="flex items-center space-x-4 space-x-reverse">
                    <div class="flex items-center space-x-3 space-x-reverse">
                        <div class="h-8 w-8 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center">
            ...
            <nav class="p-6">
                <div class="space-y-3">
                    ...
                    <a href="{{ route('agency.dashboard') }}" 
                       class="group flex items-center px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-600 rounded-xl transition duration-200 {{ request()->routeIs('agency.dashboard') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg' : '' }}">
                    ...
                    <a href="{{ route('agency.users') }}" 
                       class="group flex items-center px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-600 rounded-xl transition duration-200 {{ request()->routeIs('agency.users*') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg' : '' }}">
                    ...
                    <a href="{{ route('agency.roles') }}" 
                       class="group flex items-center px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-600 rounded-xl transition duration-200 {{ request()->routeIs('agency.roles*') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg' : '' }}">
                    ...
                    <a href="{{ route('agency.permissions') }}" 
                       class="group flex items-center px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-600 rounded-xl transition duration-200 {{ request()->routeIs('agency.permissions*') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg' : '' }}">
                    ...
                    <a href="{{ route('agency.services') }}" 
                       class="group flex items-center px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-600 rounded-xl transition duration-200 {{ request()->routeIs('agency.services*') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg' : '' }}">
                    ...
                    <a href="{{ route('agency.profile') }}" 
                       class="group flex items-center px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-600 rounded-xl transition duration-200 {{ request()->routeIs('agency.profile*') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg' : '' }}">
