...
<body class="bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 min-h-screen">
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="flex items-center">
                            ...
                            <h1 class="text-2xl font-bold text-emerald-600">نظام السفر</h1>
                        </div>
                    </div>
                </div>
                <div class="flex items-center space-x-4 space-x-reverse">
                    <a href="/login" class="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-6 py-2 rounded-lg font-medium transition duration-200 shadow-lg hover:shadow-xl">
                        تسجيل الدخول
                    </a>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-4 space-x-reverse">
                            <div class="flex items-center justify-center w-8 h-8 bg-cyan-100 rounded-full">
                    ...
                    <div class="pt-4">
                        <a href="/login" class="inline-flex items-center bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-8 py-4 rounded-xl font-bold text-lg transition duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
                ...
                <div class="relative">
                    <div class="relative z-10">
                        ...
                        <div class="relative bg-gradient-to-br from-emerald-400 to-teal-500 rounded-3xl p-8 shadow-2xl">
                            <div class="bg-white rounded-2xl p-6 shadow-lg">
                                <!-- Travel Agency Illustration -->
                                <div class="text-center space-y-6">
                                    <!-- Globe Icon -->
                                    <div class="mx-auto w-24 h-24 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full flex items-center justify-center shadow-lg">
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        ...
                                        <div class="bg-cyan-50 rounded-lg p-3">
                                            <svg class="w-8 h-8 text-cyan-600 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 text-center">
                                        <div class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg p-3">
                                            <div class="text-2xl font-bold">500+</div>
                                            <div class="text-sm opacity-90">وكالة سفر</div>
                                        </div>
                                        <div class="bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-lg p-3">
                        ...
                        <!-- Floating Elements -->
                        <div class="absolute -top-4 -right-4 w-16 h-16 bg-emerald-200 rounded-full opacity-60 animate-pulse"></div>
                        <div class="absolute -bottom-4 -left-4 w-12 h-12 bg-teal-200 rounded-full opacity-60 animate-pulse delay-1000"></div>
                        <div class="absolute top-1/2 -right-8 w-8 h-8 bg-cyan-200 rounded-full opacity-60 animate-pulse delay-500"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-emerald-100 hover:shadow-2xl transition duration-300">
                    <div class="text-center mb-6">
                        <div class="mx-auto h-16 w-16 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full flex items-center justify-center mb-4">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-cyan-100 hover:shadow-2xl transition duration-300">
                    <div class="text-center mb-6">
                        <div class="mx-auto h-16 w-16 bg-gradient-to-r from-cyan-500 to-emerald-600 rounded-full flex items-center justify-center mb-4">
                            <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- CTA Section -->
    <div class="py-16 bg-gradient-to-r from-emerald-500 to-teal-500">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <a href="/login" class="bg-white text-emerald-600 px-8 py-4 rounded-xl font-bold text-lg transition duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 inline-block">
                تسجيل الدخول الآن
            </a>
        </div>
    </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center mb-4">
                        <svg class="h-8 w-8 text-emerald-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
